...
export default function GameCard({ game, users, venue }) {
  ...
  // const profilePicture = game?.host?.profilePicture || source={require("../../assets/images/logo/placeholderLogo")};
            ...
            <Image
              source={
                game?.host?.profilePicture
                  ? { uri: game.host.profilePicture }
                  : require("../../assets/images/logo/placeholderLogo.png")
              }
